    ...
    <>
      ...
      <div className="px-40 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-8">
          <div className="col-span-2 flex justify-between h-48">
            <div className="flex">
            ...
            <div className="flex flex-col justify-between justify-self-end pr-8">
          ...
          <div className="col-span-2 flex justify-between h-48 my-8">
            <div className="flex">
              <div className="aspect-square h-48 relative">
                <Image
                  src={"/Image5.png"}
          ...
          <div className="col-span-1 min-h-48 bg-[#F2F3F7] p-8 row-start-1 col-start-3">
            ...
            <Button className="bg-black text-white text-md font-semibold rounded-none py-5 md:px-12 mr-8 flex w-full">
              Proceed to Checkout
            </Button>
          </div>
        </div>
